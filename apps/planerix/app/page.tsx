    ...
    <div className="min-h-screen bg-white">
      <section id="overview" className="pt-16 pb-20 px-6 bg-gradient-to-br from-blue-50 via-white to-blue-100 scroll-mt-28">
        <div className="container mx-auto max-w-4xl animate-fade-up">
          ...
          <h1 className="mt-3 text-5xl font-bold text-slate-900">Executive playbooks by industry</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {filtered.map((item) => (
              <div key={item.id} className="min-w-0 break-words rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-gray-600">Business outcome: {item.goal}</p>
                <div className="mt-4 grid gap-4 text-sm">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">Signals we monitor</p>
                  ...
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">Actions delivered to owners</p>
                    <ul className="mt-2 space-y-1 text-gray-700 list-disc list-inside break-words">
      ...
      <section id="benefits" className="py-20 px-6 bg-gray-50 scroll-mt-28">
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            <h2 className="text-4xl font-bold text-gray-900">Executive outcomes in the first 30 days</h2>
            <p className="mt-4 text-lg text-gray-600">Clear ownership, faster execution, and measurable outcomes.</p>
          </div>
      ...
      <CtaBand
        ...
        text="Share your contour and KPIs. We will deliver the first execution pack and impact baseline."
