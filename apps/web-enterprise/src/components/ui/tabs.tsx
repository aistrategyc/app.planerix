...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-full border border-border/60 bg-white/70 p-1.5 text-muted-foreground shadow-sm backdrop-blur",
      className
    )}
    {...props}
  />
