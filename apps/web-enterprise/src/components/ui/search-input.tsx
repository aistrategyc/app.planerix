...
export function SearchInput({
  ...
  }, [value, debounceMs, onSearch, results.length])
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      {isOpen && results.length > 0 && (
        <div
          ref={resultsRef}
          className="absolute top-full left-0 right-0 z-50 mt-2 max-h-64 overflow-auto rounded-2xl border border-border bg-popover shadow-xl"
        >
