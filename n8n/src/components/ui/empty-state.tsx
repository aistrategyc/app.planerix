...
export function EmptyState({
  ...
  return (
    <div className={cn(
      "flex flex-col items-center justify-center text-center rounded-3xl border border-dashed border-border/60 bg-gradient-to-b from-white/80 via-white/60 to-slate-50/70 px-6 shadow-sm",
      currentSize.container,
      className
    )}>
      {Icon && (
        <div className="flex items-center justify-center rounded-2xl bg-white/80 p-4 mb-4 shadow-sm border border-border/60">
