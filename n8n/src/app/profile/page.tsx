...
function ProfilePageContent() {
  ...
  const { tasks, loading: tasksLoading } = useTasks(profile ? { assignee_id: profile.id } : undefined)
  // State
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Profile"
        description="Manage your personal information, organization, and preferences"
        actions={
